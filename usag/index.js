...
{
    var elem = document.getElementById("qwketljkdn");
    var str = 'f'+'l'+'a'+'g' + "{you_found_me_007}";
...
function onWindowResize() {
    ...
    let ouragent = userAgentString.indexOf("eldian") > -1;
    if (ouragent) {
        var elem = document.getElementById("qwketljkdn");
        elem.setAttribute("onclick", "change()");

    } else {
        var message = document.getElementById("message");
        message.innerHTML = "You no Eldian";
    }
}
